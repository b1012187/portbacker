...
class ItemLogTest(unittest.TestCase):
    def test_init(self):
        i1 = model.ItemLog("b1012193", "test goal", "test goal_item", 1,"2013/11/11", "hogehoge")
    ...
    def test_find(self):
        ...
        model.ItemLog.delete_all(db)
        i1 = model.ItemLog("b1012193", "test goal", "test goal_item", 1,"2013/11/11", "hogehoge")
        i2 = model.ItemLog("b1012193", "test goal1", "test goal_item1", 2,"2013/11/11", "hogehoge1")
        i1.insert(db)
        i2.insert(db)
        act1 = model.ItemLog.find(db, "b1012193", 1)
        act2 = model.ItemLog.find(db, "b1012193", 2)
        self.assertTrue(act1 != None)
        self.assertTrue(act2 != None) 
